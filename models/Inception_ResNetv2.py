...
class Conv2d(nn.Module):
    """
    Creates and passes a convolutional layer, batch normalisation layer and ReLU activation 
...
class Inception_ResNetv2(BaseModel):
    def __init__(self, num_classes: int = 2, loss_fn: Callable = F.cross_entropy, print_metrics: bool = True, in_channels=1, k=256, l=256, m=384, n=384):
        super(Inception_ResNetv2, self).__init__(num_classes, loss_fn, print_metrics)
        blocks = []
