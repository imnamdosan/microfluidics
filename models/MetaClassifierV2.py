...
class MetaClassifierV2(BaseModel):
    """
    ...
    def __init__(self, num_classes: int = 2, loss_fn: Callable = F.cross_entropy, print_metrics: bool = True) -> None:
        super(MetaClassifierV2, self).__init__(num_classes, loss_fn, print_metrics)
    ...
    def forward(self, x):
        ...
        out = torch.cat([resnet34_out, inceptionv3_out, densenet161_1_out, densenet161_2_out, vgg16_out], dim=1)
