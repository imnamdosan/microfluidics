...
class Inception_V3_Raw(BaseModel):
    """
    INCEPTION net or also called GoogleNetv3, a famous convNEt trained on Imagenet from 2015 with random weights
    """
    def __init__(self, num_classes: int = 2, loss_fn: Callable = F.cross_entropy, print_metrics: bool = True) -> None:
        super(Inception_V3_Raw, self).__init__(num_classes, loss_fn, print_metrics)
